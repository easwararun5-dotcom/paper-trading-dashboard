  ...
  return (
    <Grid container rowSpacing={4.5} columnSpacing={2.75}>
      ...
      <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
        <AnalyticEcommerce title="Account Balance" count="₹1,00,000" percentage={59.3} extra="35,000" />
      </Grid>
      <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
        <AnalyticEcommerce title="Current P&L" count="+₹2,350" percentage={70.5} extra="8,900" />
      </Grid>
      <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
        <AnalyticEcommerce title="Open Position" count="RELIANCE" percentage={27.4} isLoss color="warning" extra="1,943" />
      </Grid>
      <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
        <AnalyticEcommerce title="Last Signal" count="BUY" percentage={27.4} isLoss color="warning" extra="20,395" />
      </Grid>
